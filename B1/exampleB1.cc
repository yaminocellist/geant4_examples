...
int main(int argc,char** argv)
{
  ...
  if ( ! ui ) {
    ...
    std::cout << "I want to say something...";
  }
  else {
    // interactive mode
    ...
    ui->SessionStart();
    delete ui;
    std::cout << "G4UIExecutive instance details:" << std::endl;
    std::cout << "Session type: " << ui->GetSession() << std::endl;
  }
  ...
  delete visManager;
  delete runManager;
  std::cout << white << "Here is a long story:" << reset;
}
